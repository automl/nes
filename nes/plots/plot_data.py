...
for data_type in data_types:
    for ens_attr in ens_attrs:
        for metric in ["loss", "error", "ece", "disagreement",
            ...
            for i, severity in enumerate(severities):
                for j, M in enumerate(args.Ms):
                    ...
                    ax.set_xlabel("Number of nets evaluated", fontsize=16)
                    #if i == 0:
                    #ax.set_title(f"M = {M}")
                    ...
                    #if metric == 'loss' and M == '3' and severity == 0:
