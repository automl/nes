...
label_names = {
    'nes_rs': 'NES-RS',
    'nes_rs_oneshot': 'NES-RS-WS',
    'nes_rs_darts': 'NES-RS-DARTS',
                    ...
                    for pool_name in args.methods:
                        ...
                        for j, M in enumerate(args.Ms):
                            ...
                            if pool_name in ["nes_re", "nes_rs", "nes_re_200",
                                             "nes_rs_200", "nes_rs_oneshot",
                                             "amoebanet_esa", "darts_esa",
                                             "nes_rs_esa", "nes_rs_darts",
                                             "darts_rs", "darts_hyper", "joint"]:
                                xs = []
                                ys = []
                        ...
                        if severity == 0:
                            severity_title = " (no dataset shift)"
                        else:
                            severity_title = f" (shift severity {severity})"
