...
def frost(x, severity=1):
    ...
    _filename = ['/cifar10-C/frost_overlays/frost1.png', '/cifar10-C/frost_overlays/frost2.png',
                '/cifar10-C/frost_overlays/frost3.png', '/cifar10-C/frost_overlays/frost4.jpg',
                '/cifar10-C/frost_overlays/frost5.jpg', '/cifar10-C/frost_overlays/frost6.jpg']

    filename = [DATA_PATH + fn for fn in _filename][idx]
