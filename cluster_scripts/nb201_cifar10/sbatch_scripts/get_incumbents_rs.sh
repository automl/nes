...
PYTHONPATH=$PWD python nes/ensemble_selection/rs_incumbents.py \
    --save_dir experiments-nb201/cifar10/outputs/deepens_rs/run_$SLURM_ARRAY_TASK_ID \
    --load_bsls_dir experiments-nb201/cifar10/baselearners/nes_rs/run_$SLURM_ARRAY_TASK_ID \
    --pool_name nes_rs \
    --dataset cifar10
