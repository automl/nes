...
PYTHONPATH=$PWD python nes/optimizers/scripts/train_deepens_baselearner.py \
	...
	--working_directory "experiments-nb201/cifar100/baselearners/deepens_rs/" \
	--dataset cifar100 --num_epochs 200 --scheme deepens_rs \
	--arch_path "experiments-nb201/cifar100/baselearners/nes_rs/run_${2}/random_archs" \
	--global_seed $2 --nb201
