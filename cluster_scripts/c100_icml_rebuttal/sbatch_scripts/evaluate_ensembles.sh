...
PYTHONPATH=$PWD python nes/ensemble_selection/evaluate_ensembles.py \
    --M 10 \
    --method $1 \
    --save_dir experiments-rebuttal/cifar100/outputs/plotting_data/run_$SLURM_ARRAY_TASK_ID \
    ...
    --load_ens_chosen_dir experiments-rebuttal/cifar100/ensembles_selected/run_$SLURM_ARRAY_TASK_ID \
    --dataset cifar100 \
    --validation_size $2
