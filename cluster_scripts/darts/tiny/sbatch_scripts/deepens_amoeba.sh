...
--working_directory "experiments/tiny/baselearners/deepens_amoebanet/" \
--dataset tiny --num_epochs 100 --scheme deepens_amoebanet \
--train_amoebanet --global_seed 1 --batch_size 128 \
