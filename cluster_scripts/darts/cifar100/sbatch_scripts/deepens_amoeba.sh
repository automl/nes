...
--working_directory "experiments/cifar100/baselearners/deepens_amoebanet/" \
--dataset cifar100 --num_epochs 100 --scheme deepens_amoebanet \
--train_amoebanet --global_seed $1
