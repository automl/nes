...
#SBATCH -J darts-hyper # sets the job name. If not specified, the file name will be used as job name
...
--working_directory "experiments/cifar100/baselearners/darts_hyper/" \
--dataset cifar100 --num_epochs 100 --scheme darts_hyper \
